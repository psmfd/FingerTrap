...
| FT-1 — Chrome | Home | **in progress** ([#58](https://github.com/psmfd/FingerTrap/issues/58), ADR-0021; slices 1–3 and the slice-2 follow-ups ([#70](https://github.com/psmfd/FingerTrap/issues/70)/[#72](https://github.com/psmfd/FingerTrap/issues/72)) landed — splits remain) |
